--[[
ReaScript Name: mk_8 x rand params applied to item as new take mutate:false rotate:false randomizerate:true
Description: mk_8 x rand params applied to item as new take mutate:false rotate:false randomizerate:true
