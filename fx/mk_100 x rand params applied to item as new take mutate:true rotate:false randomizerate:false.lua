--[[
ReaScript Name: mk_100 x rand params applied to item as new take mutate:true rotate:false randomizerate:false
Description: mk_100 x rand params applied to item as new take mutate:true rotate:false randomizerate:false
