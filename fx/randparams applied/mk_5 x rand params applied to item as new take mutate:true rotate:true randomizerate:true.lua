--[[
ReaScript Name: mk_5 x rand params applied to item as new take mutate:true rotate:true randomizerate:true
Description: mk_5 x rand params applied to item as new take mutate:true rotate:true randomizerate:true
