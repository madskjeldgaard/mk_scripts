--[[
ReaScript Name: mk_100 x rand params applied to item as new take mutate:false rotate:true randomizerate:false
Description: mk_100 x rand params applied to item as new take mutate:false rotate:true randomizerate:false
