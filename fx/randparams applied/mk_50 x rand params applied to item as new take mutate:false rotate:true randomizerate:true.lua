--[[
ReaScript Name: mk_50 x rand params applied to item as new take mutate:false rotate:true randomizerate:true
Description: mk_50 x rand params applied to item as new take mutate:false rotate:true randomizerate:true
