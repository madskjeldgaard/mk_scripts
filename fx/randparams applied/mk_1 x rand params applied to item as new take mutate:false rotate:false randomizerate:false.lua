--[[
ReaScript Name: mk_1 x rand params applied to item as new take mutate:false rotate:false randomizerate:false
Description: mk_1 x rand params applied to item as new take mutate:false rotate:false randomizerate:false
