--[[
ReaScript Name: 100 x randomize fx parameters of focused track fx and apply to selected item(s) (mutating)
Description: 100 x randomize fx parameters of focused track fx and apply to selected item(s) (mutating)
