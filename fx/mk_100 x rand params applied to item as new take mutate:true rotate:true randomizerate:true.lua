--[[
ReaScript Name: mk_100 x rand params applied to item as new take mutate:true rotate:true randomizerate:true
Description: mk_100 x rand params applied to item as new take mutate:true rotate:true randomizerate:true
