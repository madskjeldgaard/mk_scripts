--[[
ReaScript Name: mk_8 x rand params applied to item as new take mutate:true rotate:false randomizerate:false
Description: mk_8 x rand params applied to item as new take mutate:true rotate:false randomizerate:false
