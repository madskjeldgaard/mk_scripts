--[[
ReaScript Name: mk_5 x rand params applied to item as new take mutate:false rotate:false randomizerate:false
Description: mk_5 x rand params applied to item as new take mutate:false rotate:false randomizerate:false
