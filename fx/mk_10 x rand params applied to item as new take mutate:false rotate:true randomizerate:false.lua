--[[
ReaScript Name: mk_10 x rand params applied to item as new take mutate:false rotate:true randomizerate:false
Description: mk_10 x rand params applied to item as new take mutate:false rotate:true randomizerate:false
